...
const ProjectsPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Projects - CodeIntervu</title>
        <meta
          name="description"
          content="Explore real-world projects built with modern technologies. Learn from practical examples and enhance your portfolio with CodeIntervu projects."
        />
        <meta
          name="keywords"
          content="projects, portfolio, web development, MERN stack, React projects, Node.js projects, programming projects"
        />

        {/* Open Graph */}
        <meta property="og:title" content="Projects - CodeIntervu" />
        <meta
          property="og:description"
          content="Explore real-world projects built with modern technologies. Learn from practical examples and enhance your portfolio."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://codeintervu.com/projects" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Projects - CodeIntervu" />
        <meta
